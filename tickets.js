...
//NORMAL AND PEAK HOURS SEPERATED AND DECLARED
 const normalHourSlots = [7,8, 9, 13, 14];
 const peakHourSlots = [10, 11, 12, 15, 16, 17];
...
//TIME PERIOD AND DUARTION STORED TO LOCL STORAGE AND IS SHOWN IN THE SUMMARY TABLE
const timePeriod = startingHour + ".00 to " + finishingHour  + ".00";
